export const enUS = {
  ...
  studio: {
    title: "Studio",
    create: "Create from your sources",
    createDescription: "Turn grounded research into reusable learning artifacts.",
    ...
    generateSuccess: "Studio artifact created",
    generateFailed: "Failed to create Studio artifact",
    requiresContext: "Add a processed source or note to unlock Studio.",
    savedArtifacts: "Saved artifacts",
    emptyTitle: "No artifacts yet",
    emptyDescription: "Generate an artifact or write a note to keep it here.",
  },
  notebooks: {
    title: "Notebooks",
    newNotebook: "New Notebook",
  ...
  podcasts: {
    generateEpisode: "Generate Audio Overview",
    generateEpisodeDesc: "Choose the notebook evidence and listening style for a grounded Audio Overview.",
    defaultEpisodeName: "{{name}} Audio Overview",
    audioSetupRequired: "Audio setup required",
    audioSetupRequiredDesc: "Configure a language model and a text-to-speech voice in a podcast profile before generating an Audio Overview.",
    configureAudio: "Configure audio profiles",
    audioOverviews: "Audio Overviews",
    loadingAudioOverviews: "Loading Audio Overviews…",
    loadingAudio: "Loading audio…",
    playAudioOverview: "Play {{name}}",
  ...
  modelRouting: {
    ...
    chooseModelDescription: "Choose where inference runs for this workflow. Your selection is explicit and never falls back to another provider.",
    privateLocal: "Private & local",
    privateLocalDescription: "Runs on your hardware or a private endpoint you control.",
    frontierCloud: "Frontier cloud",
    frontierCloudDescription: "Uses a cloud provider and sends the request context to that provider.",
    ...
    blockedLocalOnly: "Cloud models are disabled by the local-only deployment policy.",
    blockedCloudOnly: "Local models are disabled by the cloud-only deployment policy.",
    cloudPrivacyNotice: "Notebook context for this request will be sent to {{provider}}.",
    noLocalModels: "No local language models are registered.",
    noCloudModels: "No cloud language models are registered.",
    usedModel: "Answered with {{name}}",
    generatedWith: "Generated with {{name}}",
    routingPolicy: "Routing: {{policy}}",
    policyHybrid: "Local + cloud",
    policyLocalOnly: "Local only",
    policyCloudOnly: "Cloud only",
    modelForStudio: "Model for Studio",
  ...
  apiKeys: {
    ...
    localGatewayTitle: "Local private models",
    localGatewayDescription: "Connect this notebook to the loopback-only LocalAISandbox gateway. Cloud providers remain a separate explicit choice.",
    useLocalGateway: "Use local gateway",
    localGatewayKeyHint: "Enter the gateway API key from LocalAISandbox. It is encrypted and is never returned by the API.",
